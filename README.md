...
5. **[Menu.lua](Menu.lua)**
   - Interfaz central de configuración `/shield`, incluida la configuración de las barras, recursos y Unlock/Lock global.
...
9. **[AbsorbIndicator.lua](AbsorbIndicator.lua)**
   - Helper ligero para la creación de StatusBar transparentes sobre los marcos de salud.
