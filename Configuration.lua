...
local DEFAULTS = {
    configVersion = 9, point = "BOTTOM", relativePoint = "BOTTOM", xOffset = 100, yOffset = 450,
...
local FIELD_VALIDATORS = {
    width = IsPositiveNumber, height = IsPositiveNumber,
    capMultiplier = function(value) return type(value) == "number" and value >= MIN_CAP_PERCENT / 100 end,
    hideExternalBar = IsBoolean, showHealth = IsBoolean, showSpecialResources = IsBoolean,
    showClassResourceOverlay = IsBoolean, alwaysInParty = IsBoolean,
    ...
    showTargetTarget = IsBoolean, targetTargetWidth = IsPositiveNumber, targetTargetHeight = IsPositiveNumber,
    targetTargetLocked = IsBoolean, targetTargetPoint = IsPoint, targetTargetRelativePoint = IsPoint,
    ...
    showMouseSpecialResources = IsBoolean, showMouseCooldown1 = IsBoolean, showMouseCooldown2 = IsBoolean,
    mouseCooldown1Spell = IsOptionalSpellID, mouseCooldown2Spell = IsOptionalSpellID,
...
addon.PlayerBarConfig = {
    Initialize = Initialize, Get = function() return config end, Reset = Reset,
